  ...
  return (
    <div className="">
      <div className={`hidden ${right ? "justify-end" : "justify-start" } "items-end relative md:flex`}>
        <div className='img-container relative w-4/6 hover:scale-110 transition-all duration-300'>
      ...
      <div className={`flex flex-col ${right ? "items-end" : "items-start" } "justify-end relative md:hidden`}>
        ...
        <img src={project?.postImage?.url} className={`w-4/5 ${right ? "left-0 start-right": "right-0 start-left"}`}/>
